    ...
    for vv in var:
      ...
      for frame in range(4):
        ...
        if vv == 'mslp_pcpn':
            ...
            #day 1
        dl = downloadLink(url_base+vv+'_nafr_'+str(forecast_num+8)+'.png', os.path.join(saveDir,'ECMWF_'+vv+'_'+fig_day1[frame]))
        count_good_links += dl
        count_bad_links += (1 - dl)
        status.append(dl)
      ...
      for frame in range(4):
        if vv == 'mslp_pcpn':
            ...
            forecast_num = frame*2+1
        #day 2
        dl = downloadLink(url_base+vv+'_nafr_'+str(forecast_num+16)+'.png', os.path.join(saveDir,'ECMWF_'+vv+'_'+fig_day2[frame]))
        count_good_links += dl
        count_bad_links += (1 - dl)
        status.append(dl)
      ...
      for frame in range(13):
        ...
        if vv == 'mslp_pcpn':
            ...
            forecast_num = frame*2+1
        dl = downloadLink(url_base+vv+'_nafr_'+str(forecast_num+24)+'.png', os.path.join(saveDir,'ECMWF_'+vv+'_'+fig_day3[frame]))
        count_good_links += dl
        count_bad_links += (1 - dl)
        status.append(dl)
  ...
  if switches['GFS_prediction']:
    ...
    for vv in var:
      ...
      for frame in range(4):
        ...
        dl = downloadLink(url_base+vv+'_nafr_'+str(forecast_num+4)+'.png', os.path.join(saveDir,'GFS_'+vv+'_'+fig_day1[frame]))
        count_good_links += dl
        count_bad_links += (1 - dl)
        status.append(dl)
      ...
      for frame in range(4):
        if vv == 'mslp_pcpn':
            ...
            forecast_num = frame+1
        #day 2
        dl = downloadLink(url_base+vv+'_nafr_'+str(forecast_num+8)+'.png', os.path.join(saveDir,'GFS_'+vv+'_'+fig_day2[frame]))
        count_good_links += dl
        count_bad_links += (1 - dl)
        status.append(dl)
      ...
      for frame in range(13):
        ...
        if vv == 'mslp_pcpn':
            ...
            forecast_num = frame+1
        dl = downloadLink(url_base+vv+'_nafr_'+str(forecast_num+12)+'.png', os.path.join(saveDir,'GFS_'+vv+'_'+fig_day3[frame]))
        count_good_links += dl
        count_bad_links += (1 - dl)
        status.append(dl)
